...
public class PremierLeague implements Comparable<PremierLeague> {
	...
	//CONSTRUCTOR 1
	public PremierLeague(String temporada, LocalDateTime hora, String local, String visitante, Integer golesLocal, Integer golesVisitante,
    ...
    public Integer getNumeroDias() {
    	...
    	Long dias = ChronoUnit.DAYS.between(this.hora, hoy); //calculo los días entre la fecha del partido y la variable 'hoy'
	...
	public String toString() {
		return "PremierLeague -> [temporada=" + temporada + ", fecha=" + hora + ", local=" + local + ", visitante="
	...
	//Esto es el criterio de igualdad
	@Override
